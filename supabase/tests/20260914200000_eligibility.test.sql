...
begin
  ...
  assert exists (
    select 1 from public.plans where requires_publishable_platform and sellable
  ), 'Plus aucun SKU conditionné n''est vendable : la colonne ne distingue plus rien.';
